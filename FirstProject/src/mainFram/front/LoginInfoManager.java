...
public class LoginInfoManager {
    ...
    public void setNenId(int nen_id) {
        this.nen_id = nen_id;
        System.out.println("LoginInfoManager: nen_id가 설정되었습니다: " + nen_id);
    }

    // nen_id 가져오는 메서드
    public int getNenId() {
        System.out.println("LoginInfoManager: nen_id를 가져옵니다: " + nen_id);
        return nen_id;
    }
 ...
 // 메뉴들 설정 메서드
    public void setMenu(List<String> menus) {
        this.menus = menus;
        System.out.println("LoginInfoManager: 메뉴가 설정되었습니다: " + menus);
    }

    // 메뉴들 가져오는 메서드
    public List<String> getMenu() {
        System.out.println("LoginInfoManager: 메뉴를 가져옵니다: " + menus);
        return menus;
    }
}
